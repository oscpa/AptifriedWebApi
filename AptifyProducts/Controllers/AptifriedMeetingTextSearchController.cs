...
namespace AptifyWebApi.Controllers {
    public class AptifriedMeetingTextSearchController : AptifyEnabledApiController {
        ...
        private IList<AptifriedMeetingTextSearchResultDto> GetSearchResults(string search) {
            ...
            string fullTextIndexQuery = "SELECT mt.ID, mt.MeetingTitle, idx.[RANK] " +
            ...
            var resultingList = new List<AptifriedMeetingTextSearchResultDto>();
            foreach (object[] item in textSearchResult) {
                resultingList.Add(new AptifriedMeetingTextSearchResultDto() {
