...
namespace AptifyWebApi.Controllers {
    ...
    public class AptifriedMeetingSessionLogSesSelBaseController : AptifyEnabledApiController {
        ...
        /// <returns></returns>
        internal Aptify.Framework.BusinessLogic.GenericEntity.AptifyGenericEntityBase 
        ...
        internal IList<AptifriedMeetingDto> FindAnyConflictsInSessionChanges(
            Aptify.Framework.BusinessLogic.GenericEntity.AptifyGenericEntityBase sessionChangeEntity) {

            IList<AptifriedMeetingDto> resultingMeetingsInConflict = null;

            DataTable conflictsFound = new DataTable();
            ...
            if (sessionLogEntityProper.CheckForConflict(
                (Aptify.Framework.BusinessLogic.GenericEntity.AptifyGenericEntity)sessionChangeEntity, ref conflictsFound)) {
                List<AptifriedMeeting> conflictingMeetings = new List<AptifriedMeeting>();
